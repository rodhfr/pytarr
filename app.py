...
def copy_file(file_path, file_name, file_extension):
    file_dir, _ = os.path.split(file_path)
    source_file_path = os.path.join(file_dir, f"{file_name}{file_extension}")

    if os.path.exists(source_file_path):
        dest_file_path = os.path.join(file_dir, f"{file_name}.720p{file_extension}")
